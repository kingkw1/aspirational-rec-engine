# Digital Health Platform - Datasets

This directory contains synthetically generated datasets that can be used for Machine Learning Engineer case studies. These datasets simulate a health-focused platform where users engage in discussions with each other and have one-on-one conversations with an AI Health Coach.

## Overview

The datasets include:

1. **Conversations** - One-on-one conversations between users and an AI agent (AI Health Coach)
...
Contains conversations between individual users and the AI Health Coach. Each conversation includes:
